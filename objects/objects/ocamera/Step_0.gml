...
if (wheel != 0) 
{
	...
	// Где 960 и 320 - можете вписать свои значения. Это область, которую мы будем показывать.
	if (cameraWidth + addWidth < 1440) and (cameraWidth + addWidth > 320)
	{
		...
		cameraWidth = clamp(cameraWidth, global.CameraWidth / 2, room_width);
		cameraHeight = clamp(cameraHeight, global.CameraHeight / 2, room_height);
